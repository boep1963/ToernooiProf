<?php
//© Hans Eekels, versie 17-11-2024
//Functies bij programma ToernooiProf Online

//fun_testgebruiker($Code)
//fun_toernooinaam($T_nr, $Path)
//fun_spelersnaam($Toernooi_nr, $Sp_nummer, $Path)
//fun_spelersnummer($Toernooi_nr, $Poule_nr, $Ronde_nr, $Volg_nr, $Path)
//function fun_invertcode($Code)
//fun_aantalcar($Toernooi_nr, $Moy, $Path)
//fun_carspeler($Toernooi_nr, $Sp_nummer, $Ronde_nr, $Path)
//fun_moyspeler($Toernooi_nr, $Sp_nummer, $Ronde_nr, $Path)
//fun_maxbeurten(Toernooi_nr, $Path)
//fun_aantalronden($Toernooi, $Path)
//fun_huidigeronde($Toernooi_nr, $Path)
//fun_aantalpoules($Toernooi_nr, $Ronde_nr, $Path)
//fun_aantalspelersinronde($Toernooi_nr, $Ronde_nr, $Path)
//fun_aantalspelersinpoule($Toernooi_nr, $Ronde_nr, $Poule_nr, $Path)
//fun_punten($Toernooi_nr, $Car_1_tem, $Car_1_gem, $Car_2_tem, $Car_2_gem, $Path)
//fun_stand($Toernooi_nr, $Ronde, $Poule, $Path)
//fun_even($NrTeams)
//fun_oneven($NrTeams)

//["DOCUMENT_ROOT"]=> /home/deb129009n4/domains/hanseekels.nl/public_html
//$Path = $_SERVER['DOCUMENT_ROOT'].'/../data/connectie_toernooi.php';
$Path = '/home/deb129009n4/domains/hanseekels.nl/data/connectie_toernooi.php';

//test gebruiker
function fun_testgebruiker($Code)
{
	include($Path);
	
	$Gebruikers_nummer = substr($Code, 0, 4);
	...
	try
	{
		...
		$sql = "SELECT * FROM tp_gebruikers WHERE gebruiker_nr = '$Gebruikers_nummer' AND gebruikers_code = '$Code'";
...
function fun_toernooinaam($T_nr, $Path)
{	
	include($Path);
	...
	try
	{
		...
		$sql = "SELECT * FROM tp_data WHERE t_nummer = '$T_nr'";
...
function fun_spelersnaam($Toernooi_nr, $Sp_nummer, $Path)
{
	include($Path);
	...
	try
	{
		...
		$sql = "SELECT * FROM tp_spelers WHERE t_nummer = '$Toernooi_nr' AND sp_nummer = '$Sp_nummer'";
...
function fun_spelersnummer($Toernooi_nr, $Poule_nr, $Ronde_nr, $Volg_nr, $Path)
{
	include($Path);
	...
	try
	{
		...
		WHERE t_nummer = '$Toernooi_nr' AND sp_volgnr = '$Volg_nr' AND poule_nr = '$Poule_nr' AND ronde_nr = '$Ronde_nr'";
...
//alleen voor aantal car bij invoer spelers
function fun_aantalcar($Toernooi_nr, $Moy, $Path)
{
	include($Path);
...
function fun_carspeler($Toernooi_nr, $Sp_nummer, $Ronde_nr, $Path)
{
	include($Path);
	...
	try
	{
		...
		$sql = "SELECT sp_moy FROM tp_poules WHERE t_nummer = '$Toernooi_nr' AND sp_nummer = '$Sp_nummer' AND ronde_nr = '$Ronde_nr'";
...
function fun_moyspeler($Toernooi_nr, $Sp_nummer, $Ronde_nr, $Path)
{
	include($Path);
...
function fun_huidigeronde($Toernooi_nr, $Path)
{
	include($Path);
	...
	try
	{
		...
		$sql = "SELECT t_ronde FROM tp_data WHERE t_nummer = '$Toernooi_nr'";
...
function fun_aantalpoules($Toernooi_nr, $Ronde_nr, $Path)
{
	include($Path);
	...
	try
	{
		...
		$sql = "SELECT * FROM tp_poules WHERE t_nummer = '$Toernooi_nr' AND ronde_nr = '$Ronde_nr' ORDER BY poule_nr DESC limit 1";
...
function fun_aantalspelersinronde($Toernooi_nr, $Ronde_nr, $Path)
{
	include($Path);
	...
	try
	{
		...
		$sql = "SELECT * FROM tp_poules WHERE t_nummer = '$Toernooi_nr' AND ronde_nr = '$Ronde_nr' ";
...
function fun_aantalspelersinpoule($Toernooi_nr, $Ronde_nr, $Poule_nr, $Path)
{
	include($Path);
	...
	try
	{
		...
		$sql = "SELECT * FROM tp_poules WHERE t_nummer = '$Toernooi_nr' AND poule_nr = '$Poule_nr' AND ronde_nr = '$Ronde_nr'";
...
function fun_maxbeurten($Toernooi_nr, $Path)
{
	include($Path);
	...
	try
	{
		...
		$sql = "SELECT t_max_beurten FROM tp_data WHERE t_nummer = '$Toernooi_nr'";
...
function fun_punten($Toernooi_nr, $Car_1_tem, $Car_1_gem, $Car_2_tem, $Car_2_gem, $Path)
{
	include($Path);
	$Punten = array();
	...
	try
	{
		...
		$sql = "SELECT t_punten_sys FROM tp_data WHERE t_nummer = '$Toernooi_nr'";
...
//puntensysteem
function fun_puntensysteem($Toernooi_nr, $Path)
{
	include($Path);
...
//stand voor carousel
function fun_stand($Toernooi_nr, $Ronde, $Poule, $Path)
{
	include($Path);
	$Uitslagen = array();
	
	$Aantal_spelers = fun_aantalspelersinpoule($Toernooi_nr, $Ronde, $Poule, $Path);
	$Punten_sys = fun_puntensysteem($Toernooi_nr, $Path);

	//initieren
	for ($a = 1; $a < $Aantal_spelers + 1; $a++)
	{
		$Sp_nummer = fun_spelersnummer($Toernooi_nr, $Poule, $Ronde, $a, $Path);
		$Sp_naam = fun_spelersnaam($Toernooi_nr, $Sp_nummer, $Path);
	...
	try
	{
		...
		$sql = "SELECT * FROM tp_uitslagen WHERE t_nummer = '$Toernooi_nr' AND sp_poule = '$Poule' AND t_ronde = '$Ronde' AND gespeeld = '1'";
	...
	if ($bKan == TRUE)
	{
		...
		for ($a = 1; $a < $Aantal_spelers + 1; $a++)
		{
			...
			$Car_tem_hulp = fun_carspeler($Toernooi_nr, $Sp_nummer, $Ronde, $Path);
