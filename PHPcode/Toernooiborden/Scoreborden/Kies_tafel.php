...
//Kies tafel voor scorebord 1 t/m max 12
...
<body onContextMenu="return false">
  ...
  <form name="cancel" method="post" action="../Kies_optie.php">
    <table width="800">
      <tr>
        <td height="176 " colspan="4" align="center" bgcolor="#003300">
          <input type="submit" class="submit-button" style="background-color:#CCC; width:170px; height:170px; font-size:36px;"
