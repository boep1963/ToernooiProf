  ...
  <form name="nieuw" method="post" action="Toernooi_nieuw02.php">
    <table width="700" border="0">
      ...
      <tr>
        ...
        <td align="left" valign="middle" bgcolor="#009900" class="groot">
          <input type="text" name="t_datum" size="30" minlength="5" maxlength="30" required tabindex="1">
          &nbsp;(min 5 en max 30 tekens)
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2" height="70" align="center" bgcolor="#009900" class="groot">
          <input type="submit" class="submit-button" value="Maak nieuw toernooi aan" style="width:220px; height:60px; background-color:#000; color:#FFF; font-size:16px;"
