<?php
//© Hans Eekels, versie 2-06-2025
//Bestaand toernooi verwijderen
...
<body>
  <form name="nieuw" method="post" action="Toernooi_delete02.php">
    <table width="700" border="0">
      ...
      <tr>
        <td colspan="2" height="40" align="center" valign="middle" bgcolor="#006600">
          <h1>Bestaand toernooi verwijderen</h1>
        </td>
      </tr>
      <tr>
      ...
      ?>
        ...
        <tr>
          <td colspan="2" height="70" align="center" bgcolor="#009900" class="groot">
            <input type="submit" class="submit-button" value="Kies gewenst toernooi" style="width:220px; height:60px; background-color:#000; color:#FFF; font-size:16px;"
      ...
      ?>
        <tr>
          <td height="40" colspan="2" align="center" valign="middle" bgcolor="#009900" class="grootwit">
            Geen toernooien om te openen !<br>&nbsp;
          </td>
        </tr>
        <tr>
          <td colspan="2" height="40" align="left" valign="middle" bgcolor="#009900">&nbsp;</td>
