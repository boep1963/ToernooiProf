...
array(2) { ["t_nummer"]=> string(1) "1" ["user_code"]=> string(10) "1001_CHR@#" }
*/
$bAkkoord = TRUE;
...
<body>
  <form name="kies" method="post" action="Keuze_ov.php">
    <table width="700" border="0">
      ...
      <tr>
        <td height="40" colspan="2" align="center" valign="middle" bgcolor="#009900" class="grootwit"><strong>Kies ronde</strong></td>
      </tr>
      <tr>
        <td height="40" colspan="2" align="center" valign="middle" bgcolor="#009900" class="grootwit">
          <select name="ronde_nr" style="font-size:16px">
            <?php
            for ($a = 1; $a < $Huidige_ronde + 1; $a++) {
              $Num = $a;
              $Nr_spelers = fun_aantalspelersinronde($Gebruiker_nr, $Toernooi_nr, $a, $Path);
              $Naam = "Ronde " . $a . " [met " . $Nr_spelers . " spelers]";
              if ($a == 1) {
            ?>
      ...
      <tr>
        <td colspan="2" height="70" align="center" bgcolor="#009900" class="groot">
          <input type="submit" class="submit-button" value="Akkoord" style="width:200px; height:50px; background-color:#000; color:#FFF; font-size:16px;"
  ...
  <form name="cancel" method="post" action="../Toernooi_Beheer.php">
    <table width="700">
      <tr>
        <td width="187" height="45" align="center" bgcolor="#006600">
