...
//Speler verwijderen: kies speler
...
try {
  ...
  if (mysqli_num_rows($res) == 0) {
    ...
    while ($resultaat = mysqli_fetch_array($res, MYSQLI_BOTH)) {
      ...
      $Nm = $resultaat['sp_naam'];
      $My = $resultaat['sp_startmoy'];
      $Spelers[$teller]['naam'] = $Nm . " (" . $My . ")";
    }
...
<body>
  <form name="kies" method="post" action="Spelers_delete01.php">
      ...
      ?>
        ...
        <tr>
          <td colspan="2" height="70" align="center" bgcolor="#009900" class="groot">
            <input type="submit" class="submit-button" value="Kies speler" style="width:220px; height:40px; background-color:#000; color:#FFF; font-size:16px;"
