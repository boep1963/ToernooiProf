...
//Speler verwijderen
//car_sys toegevoegd en dus aantal car
...
<body>
  <form name="delete" method="post" action="Spelers_delete02.php">
    <table width="700" border="0">
      ...
      <tr>
        <td height="40" align="left" valign="middle" bgcolor="#009900" class="grootwit">&nbsp;Moyenne en Car</td>
        <td align="left" valign="middle" bgcolor="#009900" class="grootwit">
          <?php print("Moyenne: $Smoy en Aantal caramboles: $Scar"); ?>
        </td>
      </tr>
      <tr>
        <td height="40" align="left" valign="middle" bgcolor="#009900" class="grootwit">&nbsp;Start-poule</td>
        <td align="left" valign="middle" bgcolor="#009900" class="grootwit">
          <?php print("$Poule"); ?>
        </td>
      </tr>
      <tr>
        <td colspan="2" height="30" align="center" bgcolor="#FF0000" class="grootwit">
          Let op ! Een verwijdering kunt u niet meer ongedaan maken !
        </td>
      <tr>
        <td colspan="2" height="70" align="center" bgcolor="#009900">
          <input type="submit" class="submit-button" value="Verwijder speler" tabindex="4" style="width:220px; height:60px; background-color:#000; color:#FFF; font-size:16px;"
  ...
  <form name="cancel" method="post" action="../Spelers_Beheer.php">
    <table width="700">
      <tr>
        ...
        <td align="right" bgcolor="#006600" class="klein">&copy; SpecialSoftware <?php print("$Copy"); ?>&nbsp;</td>
      </tr>
    </table>
  </form>
</body>
