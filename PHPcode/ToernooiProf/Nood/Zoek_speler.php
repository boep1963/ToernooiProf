...
<body>
  <form name="kies" method="post" action="Zoek_speler01.php">
    <table width="700" border="0">
      ...
      <tr>
        <td height="40" colspan="2" align="center" valign="middle" bgcolor="#009900" class="grootwit"><strong>Kies de gezochte speler in onderstaande lijst:</strong></td>
      </tr>
      <?php
      if ($Aantal_spelers > 0) {
      ?>
