...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <title>Spelersnaam wijzigen</title>
  <meta name="Keywords" content="Biljarten, Toernooi, Hans Eekels" />
  <meta name="Description" content="Toernooiprogramma" />
  <link rel="shortcut icon" href="../Figuren/eekels.ico" type="image/x-icon" />
  <link href="../PHP/StijlCentreren.css" rel="stylesheet" type="text/css" />
...
<body>
  <form name="wiizig" method="post" action="Naam_wijzigen02.php">
    <table width="700" border="0">
      <tr>
        <td width="214" height="85" align="left" valign="middle" bgcolor="#006600"><img src="../Figuren/Logo_standaard.jpg" width="150" height="75" alt="Logo" /></td>
        <td width="476" align="center" valign="middle" bgcolor="#006600">
          <h1>Naam speler wijzigen</h1>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2" height="70" align="center" bgcolor="#009900" class="groot">
          <input type="submit" class="submit-button" value="Wijzig naam speler" tabindex="4" style="width:220px; height:60px; background-color:#000; color:#FFF; font-size:16px;"
