...
array(3) { ["poule_nr"]=> string(1) "1" ["t_nummer"]=> string(1) "3" ["user_code"]=> string(10) "1000_KYZ@#" }
na keuze: keuze stand
*/
...
<body>
	<table width="700" border="0">
		<tr>
			<td width="172" height="85" align="left" valign="middle" bgcolor="#006600"><img src="<?php print("$Logo_naam"); ?>" width="210" height="105" alt="Logo" /></td>
			<td width="518" align="center" valign="middle" bgcolor="#006600" class="grootwit">
						...
						<table width="670" border="1">
							...
							<tr>
								<td colspan="9" align="center" class="grootzwart">
									...
									if ($Keuze_stand == 1) {
									?>
										<strong>Stand poule <?php print("$Poule_nr"); ?> in Toernooi-ronde <?php print("$Huidige_ronde"); ?> op basis van Punten</strong>
									<?php
									} else {
									?>
										<strong>Stand poule <?php print("$Poule_nr"); ?> in Toernooi-ronde <?php print("$Huidige_ronde"); ?> op basis van % Punten</strong>
	...
	<form name="stand02" method="post" action="Stand.php">
		<table width="700">
			<tr>
				<td height="45" align="center" bgcolor="#006600" class="grootwit">Kies soort stand</td>
