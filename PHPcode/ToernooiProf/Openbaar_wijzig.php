...
try {
	...
	$sql = "SELECT openbaar FROM tp_data WHERE gebruiker_nr = '$Gebruiker_nr' AND t_nummer = '$Toernooi_nr'";
...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Openbaar stand wijzigen</title>
	<meta name="Keywords" content="Biljarten, Toernooi, Hans Eekels" />
	<meta name="Description" content="Toernooiprogramma" />
	<link rel="shortcut icon" href="Figuren/eekels.ico" type="image/x-icon" />
	<link href="PHP/StijlCentreren.css" rel="stylesheet" type="text/css" />
...
<body>
	<form name="wijzig" method="post" action="Openbaar_wijzig01.php">
		<table width="700" border="0">
			<tr>
				<td width="210" height="85" align="left" valign="middle" bgcolor="#006600"><img src="<?php print("$Logo_naam"); ?>" width="170" height="85" alt="Logo" /></td>
				<td width="482" align="center" valign="middle" bgcolor="#006600">
					<h1>Zichtbaarheid Stand wijzigen</h1>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="center" bgcolor="#009900" class="grootwit">
					<strong>U kunt hier wijzigen of de stand(en) al dan niet openbaar zijn en dan ook door buitenstaanders op hun eigen computer opgeroepen kunnen worden.</strong>
				</td>
			</tr>
			<tr>
				...
				<td align="left" valign="middle" bgcolor="#009900" class="groot">
					<select name="openbaar">
						...
						if ($Openbaar == 1) {
						?>
							<option value="0">Nee, stand alleen op eigen computer zichtbaar</option>
							<option value="1" selected>Ja, stand kan door iedereen opgevraagd worden</option>
						<?php
						} else {
						?>
							<option value="0" selected>Nee, stand alleen op eigen computer zichtbaar</option>
