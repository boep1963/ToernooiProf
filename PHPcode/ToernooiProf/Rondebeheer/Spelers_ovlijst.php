...
//Overzicht doorgekoppelde spelers lijst
//Car_sys
...
<body>
	<form name="nieuw" method="post" action="Ronde_nieuw01.php">
					...
					<div class="scroll">
						<div id="printableArea">
							<table width="570" border="1">
								...
								<tr>
									<td colspan="3" align="center" class="grootzwart"><strong>Overzicht Spelers in ronde <?php print("$Nieuwe_ronde"); ?></strong></td>
								</tr>
								<tr>
