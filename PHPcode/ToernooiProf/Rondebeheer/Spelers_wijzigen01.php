...
try {
  ...
  if (mysqli_num_rows($res) == 0) {
    ...
    while ($resultaat = mysqli_fetch_array($res, MYSQLI_BOTH)) {
      ...
      $Spelers[$teller]['naam'] = fun_spelersnaam($Gebruiker_nr, $Toernooi_nr, $Sp_nummer, $Path);
      $Spelers[$teller]['sp_nummer'] = $Sp_nummer;
      $Spelers[$teller]['poule_nr'] = $resultaat['poule_nr'];
    }
...
<body>
  <form name="kies" method="post" action="Spelers_wijzigen02.php">
    <table width="700" border="0">
      ...
      <tr>
        <td height="40" colspan="2" align="center" valign="middle" bgcolor="#009900" class="grootwit">Kies de gewenste speler in onderstaande lijst:</td>
      </tr>
      <?php
      if ($Aantal_spelers > 0) {
      ?>
          ...
          <td height="40" colspan="2" align="center" valign="middle" bgcolor="#009900" class="grootwit">
            <select name="speler_nr">
              ...
              for ($a = 0; $a < $Aantal_spelers; $a++) {
                ...
                $Naam = $Spelers[$a]['naam'];
                $Poule_nr = $Spelers[$a]['poule_nr'];
              ?>
                <option value="<?php print("$Num"); ?>"><?php print("$Naam (poule $Poule_nr)"); ?></option>
              <?php
              }
              ?>
            </select>
      ...
      ?>
        <tr>
          <td height="40" colspan="2" align="center" valign="middle" bgcolor="#009900" class="grootwit">
            Geen spelers om te kiezen !<br>U heeft nog geen spelers doorgekoppeld naar ronde <?php print("$Nieuwe_ronde"); ?>.
          </td>
        </tr>
        <tr>
