    ...
    <table width="500" border="0">
      ...
      <tr>
        <td colspan="2" height="60" align="center" valign="middle" bgcolor="#006600">
          <form name="terug" method="post" action="Uitslag_invoeren01.php">
...
<body>
  <form name="opslaan" method="post" action="Uitslag_invoeren03.php">
    <table width="500" border="0">
      <tr>
  ...
  <form name="cancel" method="post" action="Uitslag_invoeren01.php">
    <table width="500">
      <tr>
