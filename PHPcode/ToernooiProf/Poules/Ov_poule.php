...
try {
	...
	$sql = "SELECT * FROM tp_poules WHERE gebruiker_nr = '$Gebruiker_nr' AND t_nummer = '$Toernooi_nr' AND poule_nr = '$Poule_nr' AND ronde_nr = '$Huidige_ronde'";
	...
	if (mysqli_num_rows($res) == 0) {
		...
		while ($resultaat = mysqli_fetch_array($res, MYSQLI_BOTH)) {
			...
			$Spelers[$teller]['sp_moy'] = fun_moyspeler($Gebruiker_nr, $Toernooi_nr, $Sp_nummer, $Huidige_ronde, $Path);
			$Spelers[$teller]['sp_car'] = fun_carspeler($Gebruiker_nr, $Toernooi_nr, $Sp_nummer, $Huidige_ronde, $Path);
		}
		...
		<table width="600" border="0">
			<tr>
				...
				<td colspan="2" align="center" valign="middle" bgcolor="#006600">
					<h1>Overzicht poule <?php print("$Poule_nr"); ?></h1>
				</td>
			</tr>
			<tr>
					...
					<div class="scroll">
						<div id="printableArea">
							<table width="570" border="1">
								<tr>
									<td colspan="3" align="center" valign="middle" bgcolor="#FFFFFF" class="grootzwart"><strong><?php print("$Gebruiker_naam"); ?></strong></td>
								</tr>
								<tr>
									<td colspan="3" align="center" valign="middle" bgcolor="#FFFFFF" class="grootzwart"><strong><?php print("$Toernooi_naam"); ?></strong></td>
								</tr>
								<tr>
									<td colspan="3" align="center" class="grootzwart"><strong>Overzicht Spelers in poule <?php print("$Poule_nr"); ?> in ronde <?php print("$Huidige_ronde"); ?></strong></td>
								</tr>
								<tr>
