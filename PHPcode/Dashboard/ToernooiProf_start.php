<?php
//Startpagina ToernooiProf dashboard 04-01-2026
...
<title>ToernooiProf keuze</title>
...
<body>
<form name="clubmatch" method="post" action="ToernooiProf_dashboard.php" >
<table width="425" border="0">
  <tr>
    <td colspan= "2" height="40" align="center" bgcolor="#FF6600"><strong>Kies sortering overzicht ToernooiProf Online</strong></td>
  </tr>
  <tr>
