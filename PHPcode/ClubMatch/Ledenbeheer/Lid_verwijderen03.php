...
array(2) { ["lid_nr"]=> string(1) "3" ["user_code"]=> string(10) "1002_CRJ@#" }
*/
$bAkkoord = TRUE;
      ...
      <tr>
        <td height="60" colspan="2" align="center" valign="middle" bgcolor="#003300">
          <form name="cancel" method="post" action="../../Start.php">
            <input type="submit" class="submit-button" name="Beheer" value="Terug naar start" style="width:200px; height:40px; background-color:#000; color:#FFF; font-size:16px;"
...
try {
  ...
  //delete
  $sql = "DELETE FROM bj_spelers_algemeen WHERE spa_nummer = '$Lid_nr' AND spa_org = '$Org_nr'";
...
<body>
  <table width="500" border="0">
    ...
    <tr>
      <td colspan="2" height="25" align="right" bgcolor="#003300" class="klein">&copy; Hans Eekels <?php print("$Copy"); ?>&nbsp;</td>
    </tr>
  </table>
</body>
