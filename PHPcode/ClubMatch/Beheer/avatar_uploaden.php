...
<body>
  <table width="900" border="0">
    <tr>
      <td width="234" height="85" align="left" valign="middle" bgcolor="#009900"><img id="logoAfbeelding" src="<?php print("$Logo_naam"); ?>" width="210" height="105" alt="Logo"></td>
      <td width="656" align="center" valign="middle" bgcolor="#009900" class="kop">
        ClubMatch Online<br>
    ...
    <tr>
      <td colspan="2" height="40" align="center" valign="middle" bgcolor="#006600">
        <h2>Avatar uploaden voor: <?php print("$Naam_sp"); ?> </h2>
      </td>
    </tr>
    <tr>
      <td height="50" colspan="2" align="left" bgcolor="#FFFFFF" class="grootzwart">
        <div style="margin:10px">
          U kunt hier een avatar (foto) uploaden voor <?php print("$Naam_sp"); ?>, dat wordt gebruikt in het programma op de scoreborden.
          Dit zijn de eisen die aan uw figuur worden gesteld:
          <ul>
            ...
            <li>De verhouding breedte : hoogte dient 1 : 1 te zijn. De foto wordt namelijk altijd verkleind of vergroot tot een breedte van 200px en een hoogte van 200px;
              dus als de verhouding niet 1 op 1 is, dan levert dat een vervormde avatar op.</li>
            <li>Als u eerder een avatar voor deze speler hebt ge-upload, dan wordt bij een nieuwe upload de oude avatar (zonder waarschuwing) overschreden.</li>
          </ul>
        </div>
      </td>
    </tr>
    <tr>
      <td colspan="2" height="80" align="center" valign="middle" bgcolor="#006600">
        <form action="avatar_opslaan.php" method="post" enctype="multipart/form-data">
