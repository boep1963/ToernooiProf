...
if (isset($_POST['speler_nr'])) {
  ...
  if (filter_var($Speler_nr, FILTER_VALIDATE_INT) == FALSE) {
    ...
    $Speler_naam = fun_ledennaam($Speler_nr, $Org_nr, $Path);
  }
} else {
  $bAkkoord = FALSE;
}
...
$target_file = $target_dir . "Avatar_" . $Org_nr . "_" . $Speler_nr . ".jpg";
...
<body>
  <table width="500" border="0">
    ...
    <tr>
      <td height="50" colspan="2" align="center">
        <div style="margin-left:5px; margin-right:5px; margin-bottom:5px; margin-top:5px; font-size:16px; font-weight:bold; background-color:#F00; color:#FFF;">
          Avatar van <?php print("$Speler_naam"); ?> verwijderd !
        </div>
      </td>
    </tr>
    <tr>
