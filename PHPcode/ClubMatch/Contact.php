...
try {
  ...
  $sql = "SELECT org_wl_email FROM bj_organisaties WHERE org_nummer = '$Org_nr' AND org_code = '$Code'";
...
<body>
  <form name="nieuw" method="post" action="Contact02.php">
    <table width="700" border="0">
      <tr>
        <td width="210" height="75" align="left" valign="middle" bgcolor="#006600"><img id="logoAfbeelding" src="<?php print("$Logo_naam"); ?>" width="150" height="75" alt="Logo" /></td>
      ...
      <tr>
        <td height="40" colspan="2" align="center" valign="middle" bgcolor="#009900" class="grootwit">
          <strong><?php print("$Org_naam"); ?>"</strong>
        </td>
      </tr>
      <tr>
