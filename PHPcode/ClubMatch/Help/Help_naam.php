  ...
  <table width="400" border="0">
    <tr>
      <td width="400" height="31" align="center" valign="middle" bgcolor="#009900">
        <h1>Help bij Competitie-naam</h1>
      </td>
    </tr>
    <tr>
      <td height="80" align="left" valign="top" bgcolor="#009900">
        <div style="margin-left:5px; margin-right:5px; margin-top:5px; margin-bottom:5px;">
          De competitienaam is vrij te kiezen. Aangeraden wordt om een relevante naam te kiezen, omdat bij het kiezen van een competitie de door u gekozen naam in de lijst wordt getoond.
        </div>
      </td>
    </tr>
    <tr>
