...
//Gekoppelde speler verwijderen, kiezen
//Kop aangepast
//Logo refresh
...
try {
  ...
  while ($resultaat = mysqli_fetch_array($res, MYSQLI_BOTH)) {
    ...
    $Spelers[$teller]['spc_naam'] = fun_spelersnaam_competitie($Nr, $Org_nr, $Comp_nr, $Periode, 1, $Path);    //excl car
...
<body>
  <form name="speler" method="post" action="Speler_delete02.php">
    <table width="600" border="0">
      ...
      <tr>
        <td height="77" colspan="3" align="center" valign="middle" bgcolor="#009900">
          <h1>Speler verwijderen</h1>
        </td>
      </tr>
      <tr>
        <td colspan="3" align="left" bgcolor="#FF0000" class="grootwit">
          <div style="margin-left:5px; margin-bottom:5px; margin-right:5px; margin-top:5px;">
            Let op bij het verwijderen van een speler:
            <ul>
              <li>U kunt het verwijderen van een speler NIET meer ongedaan maken!</li>
              <li>Naast het verwijderen van een speler worden ook zijn/haar uitslagen verwijderd en bij alle tegenstanders !</li>
              <li>De speler en de uitslagen worden verwijderd in alle aangemaakte perioden !</li>
              <li>NB: een gekoppelde speler die u in deze competitie verwijdert, blijft gewoon gekoppeld aan mogelijk andere competities en blijft ook beschikbaar om weer aan deze competitie te koppelen.</li>
            </ul>
          </div>
        </td>
      </tr>
      <tr>
        <td height="40" colspan="3" align="center" valign="middle" bgcolor="#009900" class="grootwit"><strong>Kies speler om te verwijderen</strong></td>
      </tr>
      <tr>
        <td height="40" colspan="3" align="center" valign="middle" bgcolor="#009900">
          <select name="speler" style="font-size:18px;">
            <option value="0" selected>Kies speler</option>
            <?php
      ...
      <tr>
        <td height="40" colspan="3" align="center" valign="middle" bgcolor="#009900">
          <input type="submit" class="submit-button" value="Akkoord: naar stap 2" style="width:200px; height:30px; background-color:#000; color:#FFF; font-size:16px;"
            title="Naar stap 2" onMouseOver="mouseInBut(event)" onMouseOut="mouseOutBut(event)" tabindex="3">
