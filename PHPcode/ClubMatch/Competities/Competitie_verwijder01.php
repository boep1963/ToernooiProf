...
<body>
  <form name="competitie" method="post" action="Competitie_verwijder02.php">
    <table width="800" border="0">
      ...
      <tr>
        <td colspan="2" align="center" valign="middle" bgcolor="#009900">
          <h2>Kies competitie om te verwijderen</h2>
        </td>
      </tr>
      <tr>
        <td height="40" colspan="2" align="center" bgcolor="#009900" class="grootwit">
          <strong>Waarschuwing !!</strong><br><br>
          Als u een competitie verwijdert, worden ook alle gekoppelde spelers en alle uitslagen verwijderd. Als dat niet de bedoeling is: kies dan <strong>Cancel</strong>.
          <br><br>Kies een competitie in onderstaande lijst:
        </td>
      </tr>
      <tr>
  ...
  <form name="cancel" method="post" action="../ClubMatch_start.php">
    <table width="800" border="0">
      <tr>
        ...
        <td align="right" bgcolor="#009900" class="klein">&copy; Hans Eekels <?php print("$Copy"); ?>&nbsp;
        </td>
      </tr>
    </table>
  </form>
