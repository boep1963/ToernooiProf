...
//Bestaande competitie kiezen
//kiezen bij geen comp niet toegestaan
//Kop gewijzigd
//Logo refresh
...
<body>
	<form name="competitie" method="post" action="Competitie_beheer.php">
		<table width="800" border="0">
			<tr>
				<td width="170" height="85" align="left" valign="middle" bgcolor="#009900"><img id="logoAfbeelding" src="<?php print("$Logo_naam"); ?>" width="210" height="105" alt="Logo"></td>
			...
			<tr>
				<td height="40" colspan="2" align="center" bgcolor="#009900" class="grootwit">
					Kies een competitie in onderstaande lijst om te openen:</td>
			</tr>
			<tr>
