...
//Uitslag handmatig invoeren stap 1
//Kop aangepast
//Logo refresh
      ...
      <tr>
        <td height="20" colspan="3" align="center" bgcolor="#009900">
          <div style="margin:10px; font-size:16px">
            <h2>Uitslag invoeren stap 1</h2>
            Kies 2 spelers en de gewenste periode.<br>
            NB: als deze spelers al een keer tegen elkaar hebben gespeeld in de gekozen periode, krijgt u een waarschuwing.
          </div>
        </td>
      </tr>
      <tr>
        <td width="150" height="40" align="center" valign="middle" bgcolor="#009900" class="grootwit"><strong>Kies periode</strong></td>
        <td width="218" align="center" valign="middle" bgcolor="#009900" class="grootwit"><strong>Speler 1</strong></td>
        <td align="center" valign="middle" bgcolor="#009900" class="grootwit"><strong>Speler 2</strong></td>
      </tr>
      <tr>
