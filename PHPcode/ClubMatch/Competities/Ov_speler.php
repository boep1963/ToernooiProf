...
try {
  ...
  if (mysqli_num_rows($res) == 0) {
    ...
    while ($resultaat = mysqli_fetch_array($res, MYSQLI_BOTH)) {
      ...
      $Spelers[$teller]['spc_naam'] = fun_spelersnaam_competitie($Nr, $Org_nr, $Comp_nr, $Periode, 1, $Path);
...
<body>
  <form name="speler" method="post" action="Ov_speler02.php">
    <table width="600" border="0">
      ...
      <tr>
        <td height="77" colspan="2" align="center" valign="middle" bgcolor="#009900">
      ...
      <tr>
        <td colspan="3" align="center" bgcolor="#009900" class="grootwit">
          <div style="margin-left:5px; margin-bottom:5px; margin-right:5px; margin-top:5px;">
            U kunt van een speler een overzicht opvragen (en daarna uitprinten) met de resultaten per periode en totaal.
          </div>
        </td>
      </tr>
      <tr>
        <td height="40" colspan="3" align="center" valign="middle" bgcolor="#009900" class="grootwit"><strong>Kies speler</strong></td>
      </tr>
      <tr>
        <td height="40" colspan="3" align="center" valign="middle" bgcolor="#009900">
          ...
          ?>
            <select name="speler" style="font-size:16px;">
              <?php
      ...
      <tr>
        <td height="40" colspan="3" align="center" valign="middle" bgcolor="#009900">
          ...
          <?php
            ...
            print("Overzicht maken niet mogelijk");
          }
          ?>
        </td>
      </tr>
