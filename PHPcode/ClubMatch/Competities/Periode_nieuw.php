...
$Periode_nieuw = $Periode + 1;
$Titel = "Nieuwe periode aanmaken";
...
<body>
  <form name="periode" method="post" action="Periode_nieuw02.php">
    <table width="600" border="0">
      ...
      <tr>
        <td colspan="2" align="left" bgcolor="#FF0000">
          <div style="margin-left:5px; margin-bottom:5px; margin-right:5px; margin-top:5px; font-size:16px;">
            Wat gebeurt er als u een nieuwe periode aanmaakt:
            <ul>
              <li>De matrix wordt &quot;schoongemaakt&quot;, zodat iedereen weer tegen iedereen kan spelen en de stand wordt opgemaakt voor de nieuwe periode.</li>
              <li>U kunt hierna per speler aangeven of het moyenne (en dus het aantal te maken caramboles) van de gekoppelde spelers moet worden aangepast op basis van de resultaten in de huidge periode.
                Dit kan zowel een verhoging als een verlaging betreffen.</li>
              <li>NB : U zit nu in periode <?php print("$Periode"); ?> en u gaat dus aanmaken periode <?php print("$Periode_nieuw"); ?>.</li>
            </ul>
          </div>
        </td>
      </tr>
      ...
      <tr>
        <td height="40" colspan="2" align="center" valign="middle" bgcolor="#009900">
          <input type="submit" class="submit-button" value="Maak nieuwe periode aan" style="width:200px; height:35px; background-color:#000; color:#FFF; font-size:16px;"
