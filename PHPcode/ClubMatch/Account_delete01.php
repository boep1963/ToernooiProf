...
<body>
  <table width="700" border="0">
    <tr>
    <tr>
      <td width="170" height="85" align="left" valign="middle" bgcolor="#006600"><img id="logoAfbeelding" src="<?php print("$Logo_naam"); ?>" width="210" height="105" alt="Logo" /></td>
      ...
      <td colspan="2" align="center" valign="middle" bgcolor="#FF0000" class="grootwit">
        <div style="margin:10px">
          <strong>WAARSCHUWING<br><br>
            Als u uw account verwijdert, worden alle aangemaakte competities definitief verwijderd ! Ook alle gegevens als leden, spelers en uitslagen worden definitief verwijderd !
            Tenslotte: ook een ge-upload eigen logo en alle slides van uw eventuele dia-show worden definitief verwijderd !<br>
            <br>
            Een verwijdering van uw account kunt u niet meer ongedaan maken !</strong><br><br>
          (Uiteraard kunt u in het inlogscherm van dit programma een nieuw account aanmaken, waarmee u weer net zoveel toernooien kunt aanmaken als u wilt)
        </div>
      </td>
    </tr>
    <tr>
