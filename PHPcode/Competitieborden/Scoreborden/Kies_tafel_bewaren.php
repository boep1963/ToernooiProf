...
<body onContextMenu="return false">
  <form name="tafels" method="post" action="Toon_tafel.php">
    <table width="800" border="0">
      ...
      <tr>
        <td width="198" height="200" align="center" valign="middle" bgcolor="#003300">
          <input type="submit" name="tafel_nr" class="submit-button" style="width:195px; height:195px;"
            onmouseover="mouseInBut(event)" onMouseOut="mouseOutBut(event)"
            title="Kies tafel nummer 1" value="1">
        </td>
        <td width="198" align="center" valign="middle" bgcolor="#003300">
          <input type="submit" name="tafel_nr" class="submit-button" style="width:195px; height:195px;"
            onmouseover="mouseInBut(event)" onMouseOut="mouseOutBut(event)"
