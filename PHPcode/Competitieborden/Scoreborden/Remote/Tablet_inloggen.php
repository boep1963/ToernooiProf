...
//Tablet/mobiel inloggen voor ClubMatch Online
?>
<!DOCTYPE html>
<html>
...
<head>
	...
	<title>Inloggen ClubMatch</title>
	...
	<form name="inloggen" method="post" action="Tablet_keuze_comp.php">
		<table style="width:100%;" border="0" bgcolor="#003300">
			<tr>
				...
				<td align="center">
					<h1>Inloggen ClubMatch Online voor Scorebord-bediening<br>via tablet of smartphone</h1>
				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
