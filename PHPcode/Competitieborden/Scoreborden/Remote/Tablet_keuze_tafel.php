...
<body>
	<form name="partijen" method="post" action="Tablet_toon_tafel.php">
		<table style="width:100%;" border="0">
			...
			<tr>
				<?php
				if (fun_soorttafel($Org_nr, 1, $Path) == 2) {
				?>
					<td align="center">
				...
				if ($Aantal_tafels > 1) {
					if (fun_soorttafel($Org_nr, 2, $Path) == 2) {
					?>
						<td align="center">
				...
				if ($Aantal_tafels > 2) {
					if (fun_soorttafel($Org_nr, 3, $Path) == 2) {
					?>
						<td align="center">
				...
				if ($Aantal_tafels > 3) {
					if (fun_soorttafel($Org_nr, 4, $Path) == 2) {
					?>
						<td align="center">
			...
			?>
				<tr>
					<?php
					if (fun_soorttafel($Org_nr, 5, $Path) == 2) {
					?>
						<td align="center">
					...
					if ($Aantal_tafels > 5) {
						if (fun_soorttafel($Org_nr, 6, $Path) == 2) {
						?>
							<td align="center">
					...
					if ($Aantal_tafels > 6) {
						if (fun_soorttafel($Org_nr, 7, $Path) == 2) {
						?>
							<td align="center">
					...
					if ($Aantal_tafels > 7) {
						if (fun_soorttafel($Org_nr, 8, $Path) == 2) {
						?>
							<td align="center">
			...
			?>
				<tr>
					<?php
					if (fun_soorttafel($Org_nr, 9, $Path) == 2) {
					?>
						<td align="center">
					...
					if ($Aantal_tafels > 9) {
						if (fun_soorttafel($Org_nr, 10, $Path) == 2) {
						?>
							<td align="center">
					...
					if ($Aantal_tafels > 10) {
						if (fun_soorttafel($Org_nr, 11, $Path) == 2) {
						?>
							<td align="center">
					...
					if ($Aantal_tafels > 11) {
						if (fun_soorttafel($Org_nr, 12, $Path) == 2) {
						?>
							<td align="center">
