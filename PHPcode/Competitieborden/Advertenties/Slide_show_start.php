...
//bestanden ophalen
$directory = "../../ClubMatch/Beheer/slideshow/";
if (is_dir($directory)) {
...
?>
  ...
  <head>
    ...
    <link rel="shortcut icon" href="../../Figuren/eekels.ico" type="image/x-icon" />
    <link href="../../ClubMatch/PHP/StijlCentreren.css" rel="stylesheet" type="text/css" />
    <script src="../../ClubMatch/PHP/script_toernooi.js" defer></script>
    <style type="text/css">
      body {
        width: 500px;
        margin-top: 100px;
  ...
  <body>
    <table width="500" border="0">
      ...
      <tr>
        <td height="40" colspan="2" align="right" bgcolor="#003300" class="klein">Hans Eekels&nbsp;&copy;&nbsp;<?php print("$Copy"); ?>&nbsp;</td>
      </tr>
    </table>
  </body>
