...
array(9) { 
[1]=> string(2) "on" 
	 					//2 ontbreekt, dus niet aangevinkt !
[3]=> string(2) "on" 
[4]=> string(2) "on" 
["seconden"]=> string(1) "5"
["str_var"]=> string(256) "YTo0OntpOjE7Y...." 
["user_code"]=> string(10) "1002_CRJ@#" 
["comp_nr"]=> string(1) "1" 

["Start"]=> string(16) "Start Slide-show" }
of
["Cancel"]
*/
...
if (isset($_POST["Cancel"])) {
    ...
    <body style="background-color:#333; margin:0;">
        <form method="post" action="../Kies_optie.php">
            ...
            <input type="hidden" name="comp_nr" value="<?php echo $Comp_nr; ?>">
        </form>
    </body>
    </html>
	<?php
		...
		<table width="400" border="0">
			...
			<tr>
				<td height="25" colspan="2" align="center">
					<h2>Omschrijving van de fout(en)</h2>
				</td>
			</tr>
			<tr>
				<td height="139" colspan="2" align="center" valign="middle">
					<h1>U heeft geen enkele slide aangevinkt; een slide-show is dus niet mogelijk.<br>
						Ga terug naar het Beheersscherm.</h1>
				</td>
			</tr>
			<tr>
				<td height="35" colspan="2" align="center" bgcolor="#6CA524">
					<form name="cancel" method="post" action="../Kies_optie.php">
						<input type="submit" class="submit-button" style="width:100px; height:30px;" title="Terug " value="OK" onMouseOver="mouseInBut(event)" onMouseOut="mouseOutBut(event)">
...
<body>
	<div class="slideshow-container">
		...
		for ($b = 1; $b < $Aantal_slides + 1; $b++) {
			...
			$Pad = "../../ClubMatch/Beheer/slideshow/" . $Img;
		?>
