...
This command **requires** the project directory as an argument via `/Users/p.l.m.deboer/Documents/ClubMatch`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/p.l.m.deboer/Documents/ClubMatch/.autoforge/prompts/app_spec.txt` and `/Users/p.l.m.deboer/Documents/ClubMatch/.autoforge/prompts/initializer_prompt.md`

If `/Users/p.l.m.deboer/Documents/ClubMatch` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/p.l.m.deboer/Documents/ClubMatch/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/p.l.m.deboer/Documents/ClubMatch/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/Users/p.l.m.deboer/Documents/ClubMatch/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/Users/p.l.m.deboer/Documents/ClubMatch/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/p.l.m.deboer/Documents/ClubMatch/.autoforge/prompts/`!
>
> **Files created:**
> - `/Users/p.l.m.deboer/Documents/ClubMatch/.autoforge/prompts/app_spec.txt`
> - `/Users/p.l.m.deboer/Documents/ClubMatch/.autoforge/prompts/initializer_prompt.md`
>
