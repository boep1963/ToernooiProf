  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setSuccess(`Toernooi "${data.competition.comp_naam}" is succesvol aangemaakt!`);
        setTimeout(() => {
          router.replace('/toernooien');
        }, 1500);
      } else {
        const data = await res.json();
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-slate-600 dark:text-slate-400">
          Vul de gegevens in om een nieuw toernooi aan te maken.
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-slate-900 dark:text-white focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                ...
                <div className="mb-3">
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 text-orange-600 bg-white dark:bg-slate-700 border-slate-300 dark:border-slate-500 rounded focus:ring-orange-500 focus:ring-2"
                    />
                    ...
                    <div>
                      <label className="flex items-center cursor-pointer">
                        <input
                          ...
                          checked={true}
                          disabled
                          className="w-4 h-4 text-orange-600 bg-white dark:bg-slate-700 border-slate-300 dark:border-slate-500 rounded opacity-50 cursor-not-allowed"
                        />
