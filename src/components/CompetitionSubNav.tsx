...
const navItems = [
  ...
  { label: 'Overzicht uitslagen', segment: '/uitslagen/overzicht', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16' },
  { label: 'Uitslagen per speler', segment: '/uitslagen/per-speler', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
